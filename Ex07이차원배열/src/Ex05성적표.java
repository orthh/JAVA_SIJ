...
public class Ex05성적표 {
	...
	public static void main(String[] args) {
		...
		int[][] allClass = new int[4][]; // 전체 성적
		allClass[0] = new int[3]; // 1반 성적
		allClass[1] = new int[5]; // 2반 성적
		allClass[2] = new int[4]; // 3반 성적
		allClass[3] = new int[6]; // 4반 성적
		...
		for (int i = 0; i < allClass.length; i++) {
			...
			System.out.println("\n총점 : " + sum + " 평균 : " + (double) sum / allClass[i].length);
		}
